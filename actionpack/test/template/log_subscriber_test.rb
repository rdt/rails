...
class AVLogSubscriberTest < ActiveSupport::TestCase
  ...
  def test_render_file_template
    render(:file => "test/hello_world.erb")
    wait
  ...
  def test_render_partial_with_implicit_path
    ...
    render(Customer.new("david"), :greeting => "hi")
    wait
  ...
  def test_render_collection_template
    render(:partial => "test/customer", :collection => [ Customer.new("david"), Customer.new("mary") ])
    wait
  ...
  def test_render_collection_with_implicit_path
    @view.stubs(:controller_path).returns("test")
    render([ Customer.new("david"), Customer.new("mary") ], :greeting => "hi")
    wait
  ...
  def test_render_collection_template_without_path
    @view.stubs(:controller_path).returns("test")
    render([ GoodCustomer.new("david"), Customer.new("mary") ], :greeting => "hi")
    wait
